...
I am currently a research assistant professor in the [BMT](https://biomedirobotics.com/) group, Department of Mechanical and Automation Engineering, The Chinese University of Hong Kong, directed by [Prof. Kwok Wai Samuel Au](https://www4.mae.cuhk.edu.hk/peoples/au-kwok-wai-samuel/). I am also involved in research at the [CUHK T Stone Robotics Institute](https://ri.cuhk.edu.hk/en/), particularly in [embodied healthcare service robotics for hospital and patient assistance](https://ri.cuhk.edu.hk/en/research/projects/embodied-healthcare-service-robotics-for-hospital-and-patient-assistance). I was a postdoctoral fellow in [Multi-scale Medical Robotics Center](https://www.mrc-cuhk.com/). Prior to my PhD study, I received B.E. and M.E. degrees at Harbin Institute of Technology, China. In the third year, I was visiting the group of [Prof. Hartmut Geyer](https://www.cs.cmu.edu/~hgeyer/) at Carnegie Mellon University, USA. Besides, I was visiting the Chair for Computer Aided Medical Procedures & Augmented Reality [(CAMP)](https://www.cs.cit.tum.de/camp/start/), supervised by [Prof. Nassir Navab](https://www.professoren.tum.de/en/navab-nassir), at Technical University of Munich, Germany.

I was a postdoctoral fellow at the [Multi-scale Medical Robotics Center](https://www.mrc-cuhk.com/). Prior to my PhD study, I received B.E. and M.E. degrees from Harbin Institute of Technology, China. During my PhD, I visited the group of [Prof. Hartmut Geyer](https://www.cs.cmu.edu/~hgeyer/) at Carnegie Mellon University, USA. I also visited the Chair for Computer Aided Medical Procedures & Augmented Reality [(CAMP)](https://www.cs.cit.tum.de/camp/start/), supervised by [Prof. Nassir Navab](https://www.professoren.tum.de/en/navab-nassir), at the Technical University of Munich, Germany.
...
**1. I am looking for full-time research assistants to work on medical AI safety and surgical data science for healthcare and medical robotics applications. The position is based in Hong Kong with sufficient computing resources.**
...
**3. A paid research internship opportunity is available to develop and validate pressure and flow control algorithms for a medical CO₂ insufflation system used in robot-assisted surgery, in collaboration with a medical device company.**

Latest update: Aug 4, 2026

## News
<ul id="news-list">
    <li class="news-item"><strong>[May 2026]</strong> One paper about <strong> Propeller-Assisted Robust 3D Hopping </strong> is accepted to CASE 2026 by Chuhan Zhang (Summer intern in 2025). Congrats! (Finalist for Best Student Paper Award) </li>
    ...
    <li class="news-item"><strong>[Jun. 2025]</strong> A <strong> GRF proposal </strong> is approved. </li>
